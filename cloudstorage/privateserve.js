...
const bucket = storage.bucket(process.env.GCLOUD_STORAGE_BUCKET_PRIVATE);
const bucketname = process.env.GCLOUD_STORAGE_BUCKET_PRIVATE;
...
module.exports.generateV4ReadSignedUrl =  async (fileName,time=15) => {
    try{
