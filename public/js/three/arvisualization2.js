...
function modelload(){
    ...
    loader.load( '/js/modelassets/ferrari.glb', function ( gltf ) {
        ...
        carModel.position.x = 90.1;
        carModel.position.y = -29;
        carModel.rotation.y = 2;
        carModel.scale.set(17,17,17);
...
function panorama(){
    ...
    const texture2 = new THREE.TextureLoader().load( '/js/modelassets/shutterstock_1961964328.jpg' );
